...
export const VideoTrailerModal: React.FC<VideoTrailerModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
      <div className="bg-[#022B3A] border border-white/20 w-full max-w-4xl p-4 shadow-2xl relative text-white rounded-2xl">
        <div className="flex justify-between items-center pb-3 border-b border-white/15 mb-3 font-sans">
        ...
        {/* Video Player Frame */}
        <div className="relative aspect-video bg-black border border-white/20 rounded-xl overflow-hidden group flex items-center justify-center">
          <video
            autoPlay
            loop
            muted
          ...
          <div className="absolute top-4 left-4 font-mono text-[10px] text-white bg-[#022B3A]/90 px-3 py-1 border border-white/30 rounded-md">
          ...
          <div className="absolute bottom-6 left-6 right-6 font-sans flex justify-between items-end">
            <div>
              ...
              <p className="text-[10px] text-white/70 max-w-md mt-1">
                Zero-code execution, double-entry financial ledger, and provably fair match deterministic outputs.
              </p>
            </div>
            <div className="px-3 py-1 bg-white text-[#022B3A] font-black text-[10px] uppercase rounded-full">
